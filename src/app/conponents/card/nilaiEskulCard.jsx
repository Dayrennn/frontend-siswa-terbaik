        ...
        <div className="bg-white border border-gray-100 rounded-2xl p-5">
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-sm font-medium text-gray-800">{rekap.eskul.namaEskul}</p>
                    </div>
                </div>
                <div className="flex items-center gap-2">
                    {rekap.keterangan && (
                        <span
                            className={`text-xs px-2.5 py-0.5 rounded-full font-medium ${keteranganColor[rekap.keterangan] ?? 'bg-gray-50 text-gray-600'}`}
                        >
                            {rekap.keterangan}
                        </span>
                    )}
