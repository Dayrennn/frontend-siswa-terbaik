...
export default function RemoveModal({
    ...
    if (showSuccess) {
        return <SuccessModal title={successTitle} message={successMessage} onClose={onCancel} />;
    }
        ...
        <div className='fixed inset-0 z-50 flex items-center justify-center px-4 py-6'>
            ...
            <div className='relative w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden'>
                <div className='bg-gradient-to-r from-indigo-600 to-blue-500 p-5 text-white flex items-center justify-between'>
                    ...
                    <button onClick={onCancel} className='text-white/80 hover:text-white text-lg'>
                        ✕
                    </button>
                </div>
                ...
                <div className='p-5 space-y-4'>
                    <p className='text-gray-600 text-sm text-center'>
                        ...
                        <span className='font-semibold text-gray-800'>{namaItem}</span>? Tindakan
                        ini tidak dapat dibatalkan.
                    </p>

                    {isError && <p className='text-red-500 text-sm text-center'>{errorMsg}</p>}
