...
export default function DataNilai() {
    ...
    const { data, isLoading, isError } = useSeeAllSiswaQuery({ page, limit: pageSize, search: keyword });
        ...
        },
        {
            ...
            render: (row) => (
                <div className="flex gap-2">
                    <Link href={`/page/data-nilai/${row.id}/nilai-rekap`}>
                    ...
                    <Link href={`/page/data-nilai/${row.id}/nilai-eskul`}>
                        <span className="inline-flex items-center gap-1 text-xs bg-amber-50 text-amber-600 px-3 py-1.5 rounded-lg hover:bg-amber-100 transition-colors font-medium cursor-pointer">
                            Nilai Eskul →
                        </span>
                    </Link>
                </div>
    ...
    return (
        <div className="min-h-screen bg-gray-50 p-6">
            <div className="mx-auto max-w-7xl">
                <div className="mb-5">
                    <h1 className="text-xl font-medium text-gray-900">Data Nilai</h1>
