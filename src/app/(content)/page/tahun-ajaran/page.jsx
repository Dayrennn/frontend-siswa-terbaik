...
import { useSeeAllTahunAjaranQuery, useRemoveTahunAjaranMutation } from '../../../../hooks/api/tahunAjaranSliceAPI';
...
export default function TahunAjaran() {
    ...
    const columns = [
        { key: 'no', label: 'No' },
        {
            key: 'namaTahunAjaran',
            label: 'Tahun Ajaran',
            render: (row) => <span className="font-medium text-gray-800">{row.namaTahunAjaran || '-'}</span>,
        },
        {
            key: 'status',
            label: 'Status',
